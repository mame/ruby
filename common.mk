...
rtest: fake miniruby$(EXEEXT) PHONY
	$(Q)$(exec) $(BOOTSTRAPRUBY) "$(srcdir)/bootstraptest/runner.rb" --ruby="$(BTESTRUBY) $(RUN_OPTS)" --sets=ractor
...
ractor.$(OBJEXT): {$(VPATH)}backward/2/extern.h
...
ractor.$(OBJEXT): {$(VPATH)}backward/2/r_cast.h
ractor.$(OBJEXT): {$(VPATH)}backward/2/rmodule.h
...
vm_sync.$(OBJEXT): {$(VPATH)}backward/2/extern.h
...
vm_sync.$(OBJEXT): {$(VPATH)}backward/2/r_cast.h
vm_sync.$(OBJEXT): {$(VPATH)}backward/2/rmodule.h
